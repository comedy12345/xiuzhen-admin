    ...
    <div class="header-operation-container">
        <div class="query-operation-box">
            <a-form layout="inline">
                <a-form-item label="技能buf名称">
                    <a-input></a-input>
                </a-form-item>
                <a-form-item label="所在区">
                    <a-select v-model:value="value" mode="tags" style="width: 150px" placeholder="选择区"
                              :options="options">
                    </a-select>
                </a-form-item>
                <a-form-item>
        ...
        <div class="other-operation-box">
            <a-button type="primary" @click="handlerAddSkillBuf">新增</a-button>
        </div>
        <EditSkillBuf v-if="showEditSkillBuf" @close-edit="showEditSkillBuf = false" @on-ok="showEditSkillBuf = false">
        </EditSkillBuf>
    </div>
</template>
